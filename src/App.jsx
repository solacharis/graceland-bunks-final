...
<a href={`https://wa.me/${business.whatsappNumber}?text=${encodeURIComponent("Hi Graceland Bunks, I would like to book a stay.%0A%0AName:%0ACheck-in date:%0ACheck-out date:%0ANumber of guests:%0AAny special request:")}`} target="_blank" rel="noreferrer" className="btn btn-light">Chat on WhatsApp</a>
      ...
      <a href={`https://wa.me/${business.whatsappNumber}?text=${encodeURIComponent("Hi Graceland Bunks, I would like to book a stay.%0A%0AName:%0ACheck-in date:%0ACheck-out date:%0ANumber of guests:%0AAny special request:")}`} target="_blank" rel="noreferrer" className="floating-whatsapp">WhatsApp</a>
